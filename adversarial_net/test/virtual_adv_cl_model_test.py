import sys
sys.path.insert(0, ".")
from adversarial_net.models import VirtualAdversarialClassificationModel
...
flags.add_argument(name="save_model_dir", argtype=str, default="E:/kaggle/avito/imdb_testset/adversarial_net/model/vir_adv_cl_model/vir_adv_cl_model.ckpt")
...
if __name__ == "__main__":
    ...
    vir_adv_cl_model = VirtualAdversarialClassificationModel()
    vir_adv_cl_model.build()
    vir_adv_cl_model.fit(save_model_path=flags["save_model_dir"], pretrained_model_path=flags["pretrained_model_path"])